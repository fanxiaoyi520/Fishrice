...
//    _navigationBar.backgroundColor = COLORWITHHEXSTRING(@"#F3F3F5", 1.0);
    ...
    titleLabel.font = ZD_Fout_Medium(ratioH(16));
    titleLabel.frame = CGRectMake(50, mcStatusBarHeight+9, ScreenWidth-100, 25);
    titleLabel.textColor = COLORWITHHEXSTRING(@"#FFFFFF", 1.0);
...
- (void)addBackBtn {
    ...
    UIImage *background = REImageName(@"icon_top_back");
    UIImage *backgroundOn = REImageName(@"icon_top_back");
