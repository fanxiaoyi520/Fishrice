...
-(void)creatViewController:(NSArray*)jsonArray{
    ...
    for (NSInteger i = 0; i< jsonArray.count; i++) {
        ...
        //设置tabBar的字体颜色
        [VC.tabBarItem setTitleTextAttributes:@{NSForegroundColorAttributeName:[UIColor colorWithRed:140/255.0 green:239/255.0 blue:86/255.0 alpha:1/1.0]} forState:UIControlStateSelected];
        [VC.tabBarItem setTitleTextAttributes:@{NSForegroundColorAttributeName:[UIColor whiteColor]} forState:UIControlStateNormal];
        self.tabBar.barTintColor = [UIColor colorWithRed:136/255.0 green:136/255.0 blue:136/255.0 alpha:1/1.0];
    }
}
